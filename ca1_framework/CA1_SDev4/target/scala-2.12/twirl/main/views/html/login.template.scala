...
"""),_display_(/*4.2*/main("Login")/*4.15*/ {_display_(Seq[Any](format.raw/*4.17*/("""
    ...
    """),_display_(/*15.6*/helper/*15.12*/.form(action = controllers.routes.LoginController.loginSubmit())/*15.76*/ {_display_(Seq[Any](format.raw/*15.78*/("""
        ...
        """),format.raw/*21.9*/("""<div class="form-group">
            """),_display_(/*22.14*/inputText(loginForm("email"), '_label -> "", 'class -> "form-control input-xs", 'placeholder -> "Email")),format.raw/*22.118*/("""
        """),format.raw/*23.9*/("""</div>
        <div class="form-group">
            """),_display_(/*25.14*/inputText(loginForm("password"), '_label -> "", 'class -> "form-control input-xs", 'placeholder -> "Password")),format.raw/*25.124*/("""
        """),format.raw/*26.9*/("""</div>
...
""")))}))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  DATE: Sat Mar 09 21:23:11 GMT 2019
                  SOURCE: /home/wdd/sdev4ca1v2/sdev4_CA1/ca1_framework/CA1_SDev4/app/views/login.scala.html
                  HASH: ff8fceb459a84a509a1281f2207b4416b1531e62
                  MATRIX: 966->1|1076->40|1120->56|1147->58|1168->71|1207->73|1238->78|1327->142|1364->171|1403->173|1438->182|1509->227|1556->259|1595->261|1640->279|1650->280|1679->288|1729->307|1765->316|1805->326|1837->331|1890->358|1905->364|1978->428|2018->430|2055->467|2092->628|2129->638|2142->642|2173->652|2210->662|2275->700|2401->804|2437->813|2517->866|2649->976|2685->985|2851->1137
                  LINES: 28->1|31->2|34->3|35->4|35->4|35->4|36->5|38->7|38->7|38->7|39->8|40->9|40->9|40->9|41->10|41->10|41->10|42->11|43->12|44->13|45->14|46->15|46->15|46->15|46->15|47->16|48->18|49->19|49->19|49->19|51->21|52->22|52->22|53->23|55->25|55->25|56->26|61->31
                  -- GENERATED --
              */
