...
<html>
	...
	<nav class="navbar navbar-inverse">
		...
		<ul class="nav navbar-nav">
			...
			<li """),_display_(/*28.9*/if(pagename == "Login")/*28.32*/{_display_(Seq[Any](format.raw/*28.33*/("""class ="active"""")))}),format.raw/*28.49*/("""><a href=""""),_display_(/*28.60*/routes/*28.66*/.LoginController.login()),format.raw/*28.90*/("""">Logout</a><li>
		</ul>
	    </div>
	</nav>
